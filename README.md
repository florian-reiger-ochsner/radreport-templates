...
│   └── CT/
│       ├── abdomen-becken/         # CT Abdomen + Becken v2.1 (RadLex ✅ verifiziert)
│       ├── urolithiasis/           # CT Urolithiasis v1.2 (RadLex ✅, DRG CC BY 4.0)
│       ├── lungenembolie/          # CT Lungenarterien/CTPA v1.1 (RadLex ✅ verifiziert, DRG CC BY 4.0)
...
│       └── schaedel-nativ/         # CT Schädel nativ v1.3 (RadLex ✅ verifiziert)
...
| CT Lungenarterien (CTPA) | HJK-MRRT-CT-LUNGENEMBOLIE | v1.1 | ✅ | [`template.html`](https://florian-reiger-ochsner.github.io/radreport-templates/templates/CT/lungenembolie/template.html) | [Live-Demo](https://florian-reiger-ochsner.github.io/radreport-templates/demo/ct-lungenembolie/) |
...
| CT Schädel nativ | HJK-MRRT-CT-SCHAEDEL-NATIV | v1.3 | ✅ | [`template.html`](https://florian-reiger-ochsner.github.io/radreport-templates/templates/CT/schaedel-nativ/template.html) | [Live-Demo](https://florian-reiger-ochsner.github.io/radreport-templates/demo/ct-schaedel-nativ/) |
...
**Status:** Alle 10 Templates sind vollständig registry-verifiziert (✅):
`knie-praetep`, `thorax-standard`, `thorax-liegend`, `lirads-leber`,
`ltx-hcc-evaluation`, `urolithiasis`, `schaedel-nativ`, `abdomen-becken`,
`knie-posttep` und `lungenembolie`/CTPA. Die RadLex-Codes wurden konzeptweise
gegen NCBO BioPortal (RADLEX) geprüft; vor einem Release bestätigt der Release-Gate
(`resolve-radlex.js --all` + `validate-codes.js --all --resolve`) den Gesamtstand
gegen einen frischen Cache.
